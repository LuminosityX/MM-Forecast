...
def generate_prompt(row, eventtmd5, md5tevent, classification, aligned, complementary, m52timid):
    ...
    ).format(subject, object, time,  key_facts, related_facts, compl_facts, 
...
def main(args):
    ...
    with tqdm(total=df.shape[0], desc="Event Forecasting") as pbar:
        ...
        with open("./result_ICL_graph_with_image_relation.json", "w") as f: 
            json.dump(result, f, ensure_ascii=False, indent=2)
        print('save in ./result_ICL_graph_with_image_relation.json')
